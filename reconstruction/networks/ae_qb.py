...
class AE_QB(nn.Module):
    def __init__(self, input_size=64, in_planes=1, base_width=16, expansion=1, mid_num=2048, latent_size=16,
        ...
        super(AE_QB, self).__init__()

        bottleneck = BottleNeckWithQuasiBinarize
    ...
    def forward(self, x):
        ...
        return {'x_hat': x_hat, 'z': z, 'en_features': [en1, en2, en3], 'de_features': [de1, de2, de3], 'firing_rate': firing_rate}
